class ApiEndpoints {
  ...
  /// YunXiHub 云服务器（热更新/规则仓库/账号/远程解析）
  ...
  /// 在线升级（YunXiHub 服务器热更新接口）
  static const String latestApp = '$yunxiBase/api/stable?app=yunxihub';
  ...
  /// bangumi API（v0；api.bgm.tv 在国内被墙，默认走 bgmapi.com 官方镜像）
  static const String bangumiAPIDomain = 'https://api.bgmapi.com';
  ...
  /// Bangumi Next API Domain（p1；next.bgm.tv 在国内被墙，默认走 Cloudflare Worker 代理）
  static const String bangumiAPINextDomain = 'https://bgm.yunxiapp.eu.cc';
  ...
  /// DanDanPlay API Domain（api.dandanplay.net 在国内被墙，默认走 Cloudflare Worker 代理）
  static const String dandanAPIDomain = 'https://dandan.yunxiapp.eu.cc';

  /// 弹幕源官方域名（回退用）
  static const String dandanAPIOfficialDomain = 'https://api.dandanplay.net';
