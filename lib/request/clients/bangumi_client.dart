...
class BangumiClient {
  ...
  static const String _workerNextHost = 'bgm.yunxiapp.eu.cc';
  static const String _officialNextDomain = 'https://next.bgm.tv';
  ...
  Future<dynamic> get(
    ...
    try {
      ...
      // p1 代理域名（Worker）不可达时回退官方域名
      final uri = Uri.tryParse(url);
      if (uri != null && uri.host == _workerNextHost) {
        try {
          return await _getOnce(
            url.replaceFirst(
                ApiEndpoints.bangumiAPINextDomain, _officialNextDomain),
            queryParameters: queryParameters,
            requiresAuth: requiresAuth,
            cancelToken: cancelToken,
          );
