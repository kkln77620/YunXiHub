...
class SettingsKeys {
  ...
  // 远程解析（YunXiHub 服务器化解析，默认启用）
  static const remoteResolverEnable = SettingKey<bool>(
    'remoteResolverEnable',
    true,
    group: SettingGroup.proxy,
  );
  static const remoteResolverBaseUrl = SettingKey<String>(
    'remoteResolverBaseUrl',
    'https://yunxi.yunxiapp.eu.cc',
    group: SettingGroup.proxy,
  );
  // 账号（YunXiHub 登录体系）
  static const authToken = SettingKey<String>(
    'authToken',
    '',
    group: SettingGroup.misc,
  );
  static const authEmail = SettingKey<String>(
    'authEmail',
    '',
    group: SettingGroup.misc,
  );
  static const authVipLevel = SettingKey<int>(
    'authVipLevel',
    0,
    group: SettingGroup.misc,
  );
  static const authVipExpire = SettingKey<String>(
    'authVipExpire',
    '',
    group: SettingGroup.misc,
  );
